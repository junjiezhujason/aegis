...
function request_simulation_restore() {
  ...
  //make up some data
    ...
    function prepare_graph_data(input_data, graph_plotly_config){
      let bar_names = [];
      let signal_1 = [];
      let slider = true;
      let data = {};
    ...
    function update_bar(graph_div,data, graph_plotly_config){
      let graph_data = prepare_graph_data(data, graph_plotly_config);
...
$(function() {
  ...
  $("#load_simulation_button").click(function() {
    ...
    let graph_data = prepare_graph_data(big_data, plotly_config);
    initialize_bar("ploty_all_summary",graph_data,plotly_config);
    let graph_data_small = prepare_graph_data(small_data, plotly_config);
    initialize_bar("ploty_layer_summary", graph_data_small, plotly_config)
